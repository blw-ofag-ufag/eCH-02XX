...
SCHEMA = '<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:eCH-0265="http://www.ech.ch/xlmns/eCH-0265/1" xmlns:eCH-0108="http://www.ech.ch/xmlns/eCH-0108/7" xmlns:eCH-0261="http://www.ech.ch/xmlns/eCH-0261/1/eCH-0261-1-0.xsd" xmlns:interlis-geometry="http://www.interlis.ch/geometry/1.0" targetNamespace="http://www.ech.ch/xmlns/eCH-0266/2" elementFormDefault="qualified" attributeFormDefault="unqualified" version="1.0">\n\n<!-- < targetNamespace muss angepasst werden, wenn von 0266 abgewichen wird. Für den Moment behandle ich das Dokument als v2 von 0266> -->\n\n<xs:annotation> <xs:documentation xml:lang="de">Agrardaten - Nutztiere</xs:documentation> </xs:annotation> <xs:import namespace="http://www.ech.ch/xmlns/eCH-0108/7" schemaLocation="http://www.ech.ch/xmlns/eCH-0108/7/eCH-0108-7-0.xsd"/> <xs:import namespace="http://www.ech.ch/xmlns/eCH-0261/1" schemaLocation="https://www.ech.ch/sites/default/files/imce/eCH-Dossier/0241-0270/eCH-0261/1.0.0/Beilagen/eCH-0261-1-0.xsd"/> <xs:import namespace="http://www.interlis.ch/geometry/1.0" schemaLocation="https://models.interlis.ch/refhb24/geometry.xsd"/>'
...
# write to file.
with open("v4_0266.xsd", "a", encoding="utf-8") as f:
    f.write(VERSION)
    f.write(SCHEMA)
    ...
    for u in reversed(list(unique_levels)):
        ...
        for col, val in df[::-1].iterrows():
            ...
            if u == val[0]:
                text = f'<xs:element name="{val[2]}" type="{val[14]}"><xs:annotation><xs:documentation xml:lang="de">{val[5]}</xs:documentation></xs:annotation></xs:element>\n'
                f.write(text)
